...
public class Authority implements GrantedAuthority {
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMINISTRATOR + "|" + Authority.DINER + "|" + Authority.SPONSOR + "|" + Authority.SUPERMARKET + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority = new Authority();
		authority.setAuthority(Authority.DINER);
		result.add(authority);
		...
		authority = new Authority();
		authority.setAuthority(Authority.SUPERMARKET);
		result.add(authority);
